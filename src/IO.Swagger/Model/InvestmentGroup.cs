...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class InvestmentGroup :  IEquatable<InvestmentGroup>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InvestmentGroup" /> class.
        /// </summary>
        ...
        public InvestmentGroup(string type = default(string), List<InvestmentGroupInvestment> investments = default(List<InvestmentGroupInvestment>), InvestmentGroup parent = default(InvestmentGroup), List<InvestmentGroup> children = default(List<InvestmentGroup>), int? id = default(int?), string name = default(string), string description = default(string), DateTime? createdTime = default(DateTime?), DateTime? lastModifiedTime = default(DateTime?), long? points = default(long?), bool? isFlagged = default(bool?))
        {
            this.Type = type;
        ...
        public List<InvestmentGroupInvestment> Investments { get; set; }
        ...
        public List<InvestmentGroup> Children { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InvestmentGroup {\n");
        ...
        {
            return this.Equals(input as InvestmentGroup);
        }

        /// <summary>
        /// Returns true if InvestmentGroup instances are equal
        /// </summary>
        /// <param name="input">Instance of InvestmentGroup to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InvestmentGroup input)
        {
            if (input == null)
                return false;
