...
namespace IO.Swagger.Model
{
    ...
    public partial class CustomEntityType :  IEquatable<CustomEntityType>, IValidatableObject
    {
        ...
        /// </summary>
        /// <value>Specific datatype of the custom entity type</value>
        ...
        /// </summary>
        /// <param name="dataType">Specific datatype of the custom entity type.</param>
        ...
        public CustomEntityType(DataTypeEnum? dataType = default(DataTypeEnum?), int? id = default(int?), string name = default(string), string description = default(string), DateTime? createdTime = default(DateTime?), DateTime? lastModifiedTime = default(DateTime?), long? points = default(long?), bool? isFlagged = default(bool?))
        {
