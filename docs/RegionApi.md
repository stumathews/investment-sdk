# IO.Swagger.Api.RegionApi

All URIs are relative to *https://localhost*

Method | HTTP request | Description
------------- | ------------- | -------------
[**Create**](RegionApi.md#create) | **POST** /api/Region | Create a entity
[**Delete**](RegionApi.md#delete) | **DELETE** /api/Region/{id} | Deletes and Entity
[**GenerateEntityInvestmentsGraphFor**](RegionApi.md#generateentityinvestmentsgraphfor) | **GET** /api/Region/GenerateEntityInvestmentsGraphFor/{entityId} | Generically generates a series of datapoints representing for all or one of the entitiy types.  This includes the linking of it to other entity types by joining up all the resulting entities by common investments
[**GenerateSharedGraphDataForAll**](RegionApi.md#generatesharedgraphdataforall) | **GET** /api/Region/GenerateSharedInvestmentsGraphDataForAll | Generically generates a series of datapoints representing for all or one of the entitiy types.  This includes the linking of it to other entity types by joining up all the resulting entities by common investments
[**GetAll**](RegionApi.md#getall) | **GET** /api/Region | Get all entities
[**GetAllWithoutChildren**](RegionApi.md#getallwithoutchildren) | **GET** /api/Region/WithoutChildren | Gets all entities but not their children
[**GetById**](RegionApi.md#getbyid) | **GET** /api/Region/{id} | Get Entity by ID
[**Import**](RegionApi.md#import) | **POST** /api/Region/import | 
[**Patch**](RegionApi.md#patch) | **PATCH** /api/Region/{id} | Updates an entity partially
[**Replace**](RegionApi.md#replace) | **PUT** /api/Region/{id} | Replaces and existing Entity.  Note this is not for partial updates, for that use PATCH. This is used for replacing the entire entity.  At the moment it is not possible to replace everything on the existing generic entity with that on the new one and  sometimes we dont want to: we dont want to replace the ID property for example, but we might want to replace  collections in the orignal item with the new collections in the new item, but this is currently not possible in the  implemantation. It just replaces simple members.  ** So if you want to do it propery, override this method in the controller for the type you want to implementa replacement  routine for.
...
namespace Example
{
    public class CreateExample
    {
        public void main()
        {
            ...
            var entity = new Region(); // Region | the entity to create (optional) 
            ...
            {
                Debug.Print("Exception when calling RegionApi.Create: " + e.Message );
            }
        }
    }
}
...
------------- | ------------- | ------------- | -------------
 **entity** | [**Region**](Region.md)| the entity to create | [optional] 
...
namespace Example
{
    public class DeleteExample
    {
        public void main()
        {
            ...
            {
                Debug.Print("Exception when calling RegionApi.Delete: " + e.Message );
            }
        }
    }
}
...
namespace Example
{
    public class GenerateEntityInvestmentsGraphForExample
    {
        public void main()
        {
            ...
            {
                Debug.Print("Exception when calling RegionApi.GenerateEntityInvestmentsGraphFor: " + e.Message );
            }
        }
    }
}
...
namespace Example
{
    public class GenerateSharedGraphDataForAllExample
    {
        public void main()
        {
            ...
            {
                Debug.Print("Exception when calling RegionApi.GenerateSharedGraphDataForAll: " + e.Message );
            }
        }
    }
}
...
namespace Example
{
    public class GetAllExample
    {
        public void main()
        {
            ...
            {
                // Get all entities
                List&lt;Region&gt; result = apiInstance.GetAll();
                Debug.WriteLine(result);
            }
            catch (Exception e)
            {
                Debug.Print("Exception when calling RegionApi.GetAll: " + e.Message );
            }
        }
    }
}
...
namespace Example
{
    public class GetAllWithoutChildrenExample
    {
        public void main()
        {
            ...
            {
                // Gets all entities but not their children
                List&lt;Region&gt; result = apiInstance.GetAllWithoutChildren();
                Debug.WriteLine(result);
            }
            catch (Exception e)
            {
                Debug.Print("Exception when calling RegionApi.GetAllWithoutChildren: " + e.Message );
            }
        }
    }
}
...
namespace Example
{
    public class GetByIdExample
    {
        public void main()
        {
            ...
            {
                Debug.Print("Exception when calling RegionApi.GetById: " + e.Message );
            }
        }
    }
}
...
namespace Example
{
    public class ImportExample
    {
        public void main()
        {
            ...
            var apiInstance = new RegionApi();
            var entities = new List<Region>(); // List<Region> |  (optional) 
            ...
            {
                Debug.Print("Exception when calling RegionApi.Import: " + e.Message );
            }
        }
    }
}
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **entities** | [**List&lt;Region&gt;**](Region.md)|  | [optional] 
...
namespace Example
{
    public class PatchExample
    {
        public void main()
        {
            ...
            {
                Debug.Print("Exception when calling RegionApi.Patch: " + e.Message );
            }
        }
    }
}
...
namespace Example
{
    public class ReplaceExample
    {
        public void main()
        {
            ...
            var newItem = new Region(); // Region | the contents of the entity to change (optional) 
            ...
            {
                Debug.Print("Exception when calling RegionApi.Replace: " + e.Message );
            }
        }
    }
}
 ...
 **newItem** | [**Region**](Region.md)| the contents of the entity to change | [optional] 
